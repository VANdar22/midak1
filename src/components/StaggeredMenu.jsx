    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#e9e9ef] font-medium leading-none overflow-visible pointer-events-auto focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent focus:ring-white/50"
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel fixed top-0 right-0 bottom-0 w-full max-w-[420px] bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-50 backdrop-blur-[12px] md:max-w-[420px]"
...
.sm-scope .staggered-menu-panel { width: 100%; max-width: 100%; }
