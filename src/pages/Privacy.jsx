  ...
  return (
    <div className="min-h-screen">
      <div className="w-full max-w-4xl mx-auto px-4 py-16 space-y-8">
        <header>
          <p className="text-sm tracking-wide uppercase text-[#6f35c8] font-semibold">Privacy</p>
        ...
        <section>
          ...
          <p className="text-gray-600">
            Email <a href="mailto:info@midakresearch.com" className="text-[#6f35c8] underline">info@midakresearch.com</a> if you have any questions about this policy or would like to exercise your privacy rights.
          </p>
        </section>
