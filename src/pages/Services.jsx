...
const insights = [
  {
    ...
    excerpt:
      "How we build pragmatic AI roadmaps that tie every experiment back to value.",
  },
  {
    ...
    excerpt:
      "Dashboards alone rarely change behavior. A look at rituals that do.",
  },
  {
    ...
    excerpt:
      "Lessons from public-sector partners who move fast without cutting corners.",
  },
];
...
const Services = () => {
  return (
    <PageTransition>
      <div
        className="min-h-screen font-['League_Spartan']"
      ...
      >
        ...
        >
          <div className="flex flex-col gap-10 md:flex-row md:items-end">
            <div className="flex-1">
              <AnimatedText>
                <p
                  className="text-m  font-bold  font-league_spartan uppercase  mb-4"
              ...
              <AnimatedText delay={0.2} split>
                <h1 className="text-3xl! xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl md:mb-25 text-gray-900 font-bold leading-tight tracking-tight font-['League_Spartan']">
              ...
              <div className="flex-1 max-w-xl space-y-6">
                <div className="[&>span]:inline-block [&>span]:opacity-90 mb-8">
                  <AnimatedText split={false} delay={0.25}>
                    <p className="text-lg xs:text-lg sm:text-xl md:text-xl lg:text-xl md:mt-20 text-black leading-relaxed font-['League_Spartan']">
        ...
        {/* capabilities */}
        <section
          className="mx-auto max-w-6xl px-6 py-16 space-y-10"
          style={{ backgroundColor: "#f5f5f5" }}
        >
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div>
              <p
                className="text-md font-bold uppercase mb-4 font-['League_Spartan']"
                style={{ color: `${accentColors.main}` }}
              >
                What we do
              </p>
              <h2 className="text-3xl font-bold leading-tight tracking-tight text-gray-900 font-['League_Spartan']">
                Simple structure, deep capability.
              </h2>
            </div>
            <p className="text-lg xs:text-lg sm:text-xl md:text-xl lg:text-xl text-black md:mt-8 leading-relaxed opacity-90 md:max-w-2xl font-['League_Spartan']">
              ...
              >
                <div className="space-y-8">
                  <div className="space-y-6">
                    <div className="text-base font-['League_Spartan']">
                      <span
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 font-['League_Spartan']">
                      {capability.title}
                    </h3>
                  </div>
                  <p className="text-lg text-gray-900 leading-relaxed opacity-90">
                    {capability.body}
                  </p>
        ...
        <section style={{ backgroundColor: "#f5f5f5" }}>
          <div className="mx-auto max-w-6xl px-6 py-24 space-y-16">
            <div className="max-w-4xl">
              <p
                className="text-sm uppercase tracking-[0.3em] mb-4 font-['League_Spartan']"
                style={{ color: `${accentColors.main}80` }}
              >
                Our Differentiators
              </p>
              ...
              <p className="mt-8 text-base sm:text-lg md:text-xl text-gray-900 opacity-90 max-w-2xl font-['League_Spartan']">
                Explore our unique approach to research, strategy, and the
                future of data-driven organizations.
              </p>
            </div>
                  ...
                  return (
                    <article key={title} className="space-y-6">
                      <div
                        ...
                        style={{ backgroundColor: `${accentColors.main}10` }}
                      >
                        {IconComponent && (
                          <IconComponent
                            className="h-8 w-8"
                      ...
                      <div className="space-y-4">
                        <h3 className="text-2xl font-bold leading-tight tracking-tight text-gray-900 md:text-3xl">
                          {title}
                        </h3>
        ...
        <section className="mx-auto max-w-6xl px-6 bg-[#f4f4f4] py-16 space-y-8">
          <div className="space-y-8">
            <div className="flex flex-col gap-4">
              <p
                className="text-sm font-medium uppercase tracking-[0.3em] font-['League_Spartan']"
                style={{ color: `${accentColors.main}80` }}
              >
                Latest insights
              </p>
              <h2 className="text-3xl font-bold tracking-tight mt-2 md:text-4xl font-['League_Spartan']">
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-3">
            {insights.map((item) => (
              <div
                key={item.title}
                className="flex flex-col overflow-hidden h-full border border-gray-200 transition-colors duration-300 hover:border-gray-300"
              >
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  <div className="flex-1">
                    <p
                      ...
                      style={{ color: `${accentColors.main}CC` }}
                    >
